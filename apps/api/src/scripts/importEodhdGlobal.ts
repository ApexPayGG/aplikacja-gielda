...
const EXCHANGES: ExchangeConfig[] = [
  ...
  },
  {
    ...
    companies: [
      ...
      { symbol: "SFTBY", name: "SoftBank Group ADR" },
      { symbol: "NTTYY", name: "Nippon Telegraph & Telephone ADR" },
      { symbol: "NTDOY", name: "Nintendo ADR" },
    ],
  },
  {
    exchange: "NSE",
    ...
    companies: [
      ...
      { symbol: "IBN", name: "ICICI Bank ADR" },
      { symbol: "RDY", name: "Dr. Reddy's ADR" },
    ],
  },
  {
    exchange: "KO",
